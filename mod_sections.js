...
function renderModSection(product,_modBody,_modTemp) {
    ...
    const sectionsContainer = _modBody.querySelector(`[data-type="sections-container"]`)
    const originalSectionTemplate = _modTemp.querySelector(`[data-type="section"]`);
    const originalTxtElement = _modTemp.querySelector(`[data-type="text"]`).cloneNode(true);       
    const originalImgElement = _modTemp.querySelector(`[data-type="img"]`).cloneNode(true);
    const originalTableElementTemp = _modTemp.querySelector(`[data-type="size-table"]`).cloneNode(true);
    const originalColContainer = _modTemp.querySelector(`[data-type="col-container"]`).cloneNode(true);
    ...
    Object.entries(sectionsobj).forEach(([section, secData],index) => {
        ...
        const colContainer = originalColContainer.cloneNode(true);
